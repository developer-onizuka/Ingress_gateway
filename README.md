...
| --- | --- | --- |
| Step1 | kube-Proxy & NodePort https://github.com/developer-onizuka/kubernetes#0-1-workloads | Seems to need some LoadBalances such as HAproxy outside, But it's so bother for considering to scaling out/in! Let's use LoadBalance Controller in Cloud! |
